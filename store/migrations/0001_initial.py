    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('G', 'GOLD'), ('S', 'SILVER'), ('B', 'BROZNE')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Promotion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('P', 'pending_order'), ('C', 'complete_order'), ('F', 'failed_order')], default='P', max_length=255)),
